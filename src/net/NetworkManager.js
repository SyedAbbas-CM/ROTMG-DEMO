/**
 * Client-side NetworkManager implementation
 *
 * NOTE: Server code should NOT import from this file.
 * - For protocol definitions (MessageType, BinaryPacket): import from common/protocol.js
 * - This file contains browser-specific client implementation only
 * - Used by browser clients in public/
 */

import { BinaryPacket, MessageType } from '../../common/protocol.js';

// BinaryPacket and MessageType are imported from common/protocol.js
...
// ES6 module export (primary)
export { OptimizedNetworkManager };

// Browser global export for legacy compatibility
